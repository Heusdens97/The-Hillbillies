...
public class Unit {
	 ...
	 * 			| ! canHaveAsPosition(cube)
	 */
	public Unit(String name, int[] cube, int weight, int agility, int strength, int toughness) throws ModelException{
		this.setName(name);
	...
	*/
	...
	public void setSpeed(){
	    ...
	    double[] cubePosition = new double[3];
		if ((isMoving()) && (this.getDestiny() != null))
			cubePosition[0] = this.getDestiny()[0]+0.5;
			cubePosition[1] = this.getDestiny()[1]+0.5;
			cubePosition[2] = this.getDestiny()[2]+0.5;
			if (this.getPosition()[2]-cubePosition[2] == -1)
				speed = (1/2)*speed;
