...
public class UnitTest {
	...
	public void setUp() throws Exception {
		...
		this.world = facade.createWorld(new int[50][50][50], new DefaultTerrainChangeListener());
	}
	...
	public void constructor_LegalName() throws ModelException {
		Unit name = new Unit("James O'Hara",new int[] { 1, 2, 3 }, 50,50,50,50,false,world);
		assertEquals("James O'Hara",name.getName());
	}
	
	@Test(expected = ModelException.class)
	public void constructor_IllegalSetName() throws ModelException {
		new Unit("B@rt", new int[] { 1, 2, 3 },50,50,50,50,false,world);
	}
	
	@Test
	public void constructor_LegalPosition() throws ModelException {
		Unit position_0 = new Unit("Test",new int[] { 0, 0, 0 },50,50,50,50,false,world);
		assertDoublePositionEquals(0.5,0.5,0.5,position_0.getPosition());
		int n = position_0.getMaxSize()-1;
		Unit position_49 = new Unit("Test",new int[] {n, n, n},50,50,50,50,false,world);
	...
	public void constructor_IllegalPosition() throws ModelException{
		new Unit("Test", new int []{ world.getX(), world.getY(), world.getZ()},50,50,50,50,false,world);
	}
	
	@Test
	public void constructor_LegalWeight() throws ModelException {
		Unit Weight_25 = new Unit("Test",new int[] { 0, 0, 0 },25,50,50,50,false, world);
		assertEquals(25,Weight_25.getWeight());
		Unit Weight_100 = new Unit("Test",new int[] { 0, 0, 0 },100,50,50,50,false, world);
	...
	public void constructor_IllegalWeight() throws ModelException{
		int weight = 101;
		Unit Weight = new Unit("Test",new int[] { 0, 0, 0 } ,weight,50,50,50,false, world);
		assertTrue(25 <= Weight.getWeight() && Weight.getWeight() <= 100);
	}
	
	@Test
	public void constructor_LegalAgility() throws ModelException {
		Unit Agility_25 = new Unit("Test",new int[] { 0, 0, 0 },50,25,50,50,false, world);
		assertEquals(25,Agility_25.getAgility());
		Unit Agility_100 = new Unit("Test",new int[] { 0, 0, 0 },50,100,50,50,false, world);
	...
	public void constructor_IllegalAgility() throws ModelException{
		int agility = 200;
		Unit Agility = new Unit("Test",new int[] { 0, 0, 0 } ,50, agility,50,50,false, world);
		assertTrue(25 <= Agility.getAgility() && Agility.getAgility() <= 100);
	}
	
	@Test
	public void constructor_LegalStrength() throws ModelException {
		Unit strength_25 = new Unit("Test",new int[] { 0, 0, 0 },50,50,25,50,false, world);
		assertEquals(25,strength_25.getStrength());
		Unit strength_100 = new Unit("Test",new int[] { 0, 0, 0 },50,50,100,50,false, world);
	...
	public void constructor_IllegalStrength() throws ModelException{
		int strength = 150;
		Unit Strength = new Unit("Test",new int[] { 0, 0, 0 } ,50, strength,50,50,false, world);
		assertTrue(25 <= Strength.getStrength() && Strength.getStrength() <= 100);
	}
	
	@Test
	public void constructor_LegalToughness() throws ModelException {
		Unit Toughness_25 = new Unit("Test",new int[] { 0, 0, 0 },50,50,50,25,false, world);
		assertEquals(25,Toughness_25.getToughness());
		Unit Toughness_100 = new Unit("Test",new int[] { 0, 0, 0 },50,50,50,100,false, world);
	...
	public void constructor_IllegalToughness() throws ModelException{
		int toughness = 150;
		Unit Toughness = new Unit("Test",new int[] { 0, 0, 0 } ,50, toughness,50,50,false, world);
	...
	public void constructor_LegalOrientation() throws ModelException{
		Unit name = new Unit("TestUnit",new int[] { 6, 1, 12 }, 77,33,90,60,false, world);
	...
	public void constructor_LegalMoveToAdjacent() throws ModelException {
		Unit MoveToA = new Unit("Test",new int[] { 0, 0, 0 },50,50,50,50,false,world);
	...
	public void constructor_LegalMoveTo() throws ModelException {
		Unit MoveTo = new Unit("Test",new int[] { 0, 0, 0 },50,50,50,50,false,world);
	...
	public void constructor_IllegalMoveTo() throws ModelException {
		Unit MoveTo = new Unit("Test",new int[] { 3, 1, 5 },50,50,50,50,false,world);
	...
	public void constructor_LegalWork() throws ModelException {
		Unit work = new Unit("Test",new int[] { 3, 1, 5 },50,50,50,50,false,world);
	//	work.workAt(x, y, z);();
	...
	public void constructor_getCubeCoordinates() throws ModelException {
		Unit cube = new Unit("Test",new int[] { 10, 12, 33 },50,50,50,50,false,world);
		assertIntegerPositionEquals(10,12,33,cube.getCubeCoordinate());
	}
	
	@Test
	public void constructor_Fight() throws ModelException {
		Unit attacker = new Unit("Attack",new int[] { 3, 1, 0 },50,50,50,50,false,world);
		Unit defender = new Unit("Defend",new int[] { 3, 2, 0 },50,50,50,50,false,world);
	...
	public void constructor_rest() throws ModelException {
		Unit rest = new Unit("Rest",new int[] { 0,0, 0 },50,50,50,50,false,world);
	...
	public void constructor_DefaultBehaviourEnabled() throws ModelException {
		Unit defaultbehaviour = new Unit("Test",new int[] { 0,0, 0 },50,50,50,50,false,world);
